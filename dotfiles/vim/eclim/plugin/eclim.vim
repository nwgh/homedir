...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/hurley/.eclipse/org.eclipse.platform_3.5.0_185596441/plugins/org.eclim_1.5.8'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/hurley/.eclipse/org.eclipse.platform_3.5.0_185596441'
  if has('win32unix')
